    ...
    return (
      <MainLayout>
        <div className="mb-6">
          ...
          <p className="text-slate-500">Manage TPC task approvals and policy guidance</p>
        </div>
    ...
    <MainLayout>
      ...
      <Tabs defaultValue="approvals" className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="approvals">TPC Approvals</TabsTrigger>
          <TabsTrigger value="policybot">PolicyBot</TabsTrigger>
        </TabsList>
